...
class AccountAtsDoc(models.Model):
    ...
    de datos para documentos validos  para el ats y sustentos, se instalan en configuraciones contables.
    too se configuran los diaroos de ventas con la referencia a la autorizacion de ventas y nc y el de compras
    con referencia autorizar retenciones, las autorizaciones para proveedores desde las facturas recibidas; para clientes desde
...
class AccountInvoice(models.Model):
    ...
    auth_number = fields.Char('Autorización',size=49)
