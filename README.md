...
# Si requieres asesoría para la implementación de Odoo para Ecuador con nuestra versión envía un mail a wruiz@leadsolutions.ec y podrás acceder a nuestro servicios empresariales.


Este proyecto contiene las funcionalidades
requeridas para que Odoo pueda implementarse en cualquier empresa ecuatoriana.
